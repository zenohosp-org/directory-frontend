...
export const logoutFromAssets    = () => axios.post(`${import.meta.env.VITE_ASSET_API_URL}/api/auth/logout`, {}, { withCredentials: true });
export const logoutFromInventory = () => axios.post(`${import.meta.env.VITE_INVENTORY_API_URL}/api/auth/logout`, {}, { withCredentials: true });
export const logoutFromHms       = () => axios.post(`${import.meta.env.VITE_HMS_API_URL}/api/auth/logout`, {}, { withCredentials: true });
export const logoutFromFinance   = () => axios.post(`${import.meta.env.VITE_FINANCE_API_URL}/api/auth/logout`, {}, { withCredentials: true });
